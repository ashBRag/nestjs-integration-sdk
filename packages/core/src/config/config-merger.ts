...
import { DEFAULT_INTEGRATION_CONFIG, INTEGRATION_CONFIGS } from './default-configs';
...
export class ConfigMerger {
  ...
  static getPredefined(integrationName: string): Partial<IntegrationConfig> | undefined {
